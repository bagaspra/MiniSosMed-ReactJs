    ...
    <div className="pb-5">
      ...
      <form onSubmit={commentHandler}>
        <textarea rows="5" value={comment}
          onChange={handleCommentChanged} className="block p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 my-3" />
